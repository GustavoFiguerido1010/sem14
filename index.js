...
const vaciarCarritoBtn = document.getElementById("vaciar-carrito"); // Obtener el botón de "Vaciar Carrito"
...
function mostrarProductos() {
    for (let i = 0; i < 10 && i < datosJSON.length; i++) {
        ...
        const li = document.createElement("li");
        li.innerHTML = `${producto.producto} - $${producto.precio.toFixed(2)} <button class="agregar"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
